...
const CONFIG = {
  ...
  // API tiến độ hợp đồng — Flow K chạy ParseContractProgress.ts đọc file THHD trên OneDrive,
  // trả về mảng hợp đồng đã ký (đã chuẩn hoá). Để nguyên placeholder thì trang "Tiến độ HĐ"
  // sẽ hiện hướng dẫn cấu hình thay vì lỗi.
  CONTRACT_PROGRESS_API: "https://defaultb8d21e4f3f864367b6afe47d812e19.72.environment.api.powerplatform.com:443/powerautomate/automations/direct/cu/16/workflows/bb2f8618d6664afbaeaafb35fb7e9ea1/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=tRz6oD1Hkj6K8EwS29gGgoUegyEY7rMZmOMnhvIo4Jo",
  DEMO_CONTRACT_PROGRESS_FILE: "contract_progress.sample.json",

  // Bảng tỷ giá VNĐ→USD theo tháng (VCB chuyển khoản). Flow đọc sheet "ExchangeRate" trong
  // NTSF_SharePoint_Source.xlsx, trả về mảng [{ Month:"2026-01", Rate: 25400 }, ...]
  // (Rate = số VNĐ cho 1 USD). Lô xuất đường bộ (Currency=VND) sẽ được quy đổi theo tháng xuất.
  // Để trống/placeholder thì dashboard vẫn chạy; lô VNĐ chưa có tỷ giá sẽ để doanh thu USD = 0.
  EXCHANGE_RATE_API: "https://defaultb8d21e4f3f864367b6afe47d812e19.72.environment.api.powerplatform.com:443/powerautomate/automations/direct/cu/24/workflows/0caec56425d840e5a56d927ed3cba4e3/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Uad9w37stRBy__9vTYTjS8M6Y6I8hCE1C9sJbtZMFcc",
  DEMO_EXCHANGE_RATE_FILE: "exchange_rate.sample.json",
