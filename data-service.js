...
const DataService = (function () {
  ...
  async function refresh() {
    ...
    try {
      ...
      const [salesRaw, targetsRaw, summaryRaw, saleSummaryRaw, newContractsRaw, productAliasRaw, chemicalThresholdRaw, newsRaw, contractRaw] = await Promise.all([
        fetchJSON(salesUrl),
      ...
      current = {
        shipments, targetHistory, targetsBySale, monthlySummary, saleSummary, weeklyNewContracts, productAliasRules, chemicalThresholdRules, industryNews, contractProgress,
