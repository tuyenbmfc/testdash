...
const DataService = (function () {
  ...
  async function refresh() {
    ...
    try {
      ...
      const targetHistory = (Array.isArray(targetsRaw) ? targetsRaw : (targetsRaw.value || [])).map(normalizeTargetRow).filter(Boolean);
  ...
  return { init, subscribe, getCurrent, forceRefresh, startAutoRefresh, stopAutoRefresh };
})();
